    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Text, { style: { marginTop: "10px", fontWeight: "bold" } }, "¿Qué abordaremos hoy?"),
        ...
        React.createElement(
          ...
          React.createElement(Text, { style: { fontWeight: "bold", marginBottom: "10px" } }, "Accede puntual a una de las siguientes salas de Zoom:"),
          React.createElement(
            Button,
            {
...
module.exports = ReminderSession1;
