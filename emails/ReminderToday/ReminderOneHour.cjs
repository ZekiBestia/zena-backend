      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            "⏰ ¡Falta solo 1 hora para la Sesión 2 del Seminario!"
          ),
        ...
        React.createElement(Text, { style: { fontWeight: "bold", marginTop: "20px" } }, "¡Nos vemos en la sesión! 🚀"),
...
module.exports = ReminderOneHour;
