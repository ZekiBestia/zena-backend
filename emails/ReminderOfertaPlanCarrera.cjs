        ...
        React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(Text, { style: { marginTop: '20px' } }, "Este plan fue diseñado para personas con poco tiempo y recursos, pero con una visión clara: avanzar profesionalmente con un sistema accesible y efectivo."),
                    React.createElement(Text, { style: { marginTop: '10px', fontWeight: 'bold' } }, "Precio regular: $1,994 pesos"),
                    React.createElement(Text, { style: { fontWeight: 'bold', color: '#dc3545' } }, "Precio especial por tiempo limitado: $997 pesos")
                ),
