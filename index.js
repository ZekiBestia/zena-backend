...
app.post('/register', async (req, res) => {
    ...
    try {
        ...
        // Obtener el último destinatario desde el registro anterior (antes de insertar)
        const { data: prevLeadData, error: lastLeadError } = await supabase
            .from('leads')
        ...
        const last = prevLeadData?.[0]?.ultimo_destinatario || "zeki";
        ...
        // Ahora sí: insertar al nuevo lead
